...
const Footer = () => {
  ...
  return (
    <footer className="bg-emerald-100 rounded-t-3xl mt-auto">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="logo mb-0">
          <img src="../assets/JORBestLogo.png"></img>
        </div>
                    ...
                    {teamMembers.map((member, index) => (
                      <div key={index}>
                        <div className="col-span-2 flex justify-start gap-3 ">
                          <a
                            href="#"
                            className="container w-40 text-gray-700 transition hover:opacity-75"
                          >
                            {member.name}
                          </a>
