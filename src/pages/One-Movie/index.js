  ...
  return (
    <div>
      ...
      <div className='mt-10 lg:px-5 md:px-5 sm:px-5 xs:px-5'>
        <h3 className="text-3xl text-white font-bold mx-auto p-2 text-center bg-[#276060] rounded-3xl ml-40 mr-40">
        ...
        <div className="flex flex-col my-10 justify-items-center items-left">
          <li key={oneMovie.id} className="list-none rounded-md relative ">
            <div className="flex mx-auto justify-center bg-[#276060] pt-8 pb-8 pl-6 pr-5 rounded-3xl ml-40 mr-40">
              ...
              />
              <div className="ml-5">
                <p className="mb-2 mt-3"><b>Language: </b>{oneMovie.original_language === 'en' ? 'English' : oneMovie.original_language === 'hi' ? 'Hindi' :
                ...
                <p className="mb-12"><b>Director's Name: </b>{director.name}</p>
